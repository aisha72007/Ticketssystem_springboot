...
* The original package name 'com.ticket-system' is invalid and this project uses 'com.ticketsystem' instead.
...
```
$ docker run --rm -p 8080:8080 ticket-system:0.0.1-SNAPSHOT
```
